...
| Deployment | Clean Docker and Windows builds plus actual runtime smoke; production origin/TLS/bootstrap controls; correct tunnel ownership and shutdown; feed mount works | Existing Windows CI builds only; ngrok setup/runtime and hosted TLS acceptance still need verification. |
